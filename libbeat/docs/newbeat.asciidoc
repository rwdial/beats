...
[source,shell]
----------------------------------------------------------------------
go get github.com/rwdial/beats
----------------------------------------------------------------------

In this guide, we use working examples from the Topbeat source code in https://github.com/rwdial/beats[GitHub]
...
at the https://github.com/rwdial/beats/blob/master/packetbeat/beat/packetbeat.go[Packetbeat]
code.
