...
Folder  | Description
--- | ---
[libbeat](https://github.com/rwdial/beats/tree/master/libbeat) | The Go framework for creating new Beats
[Topbeat](https://github.com/rwdial/beats/tree/master/topbeat) | Like 'top' but inserting the data into Elasticsearch
[Packetbeat](https://github.com/rwdial/beats/tree/master/packetbeat) | Tap into your wire data
[Filebeat](https://github.com/rwdial/beats/tree/master/filebeat) | Lightweight log forwarder to Logstash & Elasticsearch
[Winlogbeat](https://github.com/rwdial/beats/tree/master/winlogbeat) | Sends Windows Event logs
...
list of [community
Beats](https://github.com/rwdial/beats/blob/master/libbeat/docs/communitybeats.asciidoc).
